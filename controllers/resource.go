...
import (
	"github.com/mgw2168/etcd-operator/api/v1alpha1"
...
var (
	EtcdClusterLabelKey       = "etcd.mgw2168.io/cluster"
...
func MutateHeadlessSts(cluster *v1alpha1.EtcdCluster, sts *appsv1.StatefulSet) {
